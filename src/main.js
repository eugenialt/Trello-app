...
function styleLightTema (){
  document.body.style.background = '#3179BA'
...
function styleDarkThema (){
  document.body.style.background = 'linear-gradient(2000deg, #070714, #133863, #041b31, #050429)';
